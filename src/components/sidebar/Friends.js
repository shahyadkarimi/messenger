...
const Friends = ({ usersData }) => {
  ...
  return (
    <div onClick={() => dispatch({type:"CHANGE_USER", payload: usersData[1]})} className="friends w-full relative flex items-center gap-3 hover:bg-gray-light cursor-pointer p-3 rounded-2xl transition-all duration-200">
      <img
